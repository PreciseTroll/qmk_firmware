...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  */
  [_FL1] = LAYOUT_all(
    ...
    _______, _______, _______, _______, _______, RGB_TOG, RGB_HUD, RGB_SAI, RGB_VAI, BL_DEC,  BL_INC,  KC_DOWN, KC_RSFT, KC_MUTE, KC_VOLU, _______, _______, _______, _______,
    RGB_MODE_FORWARD, _______, _______,                            BL_TOGG,                            _______, _______, _______, _______, KC_VOLD, _______, _______, _______, _______
  ),
