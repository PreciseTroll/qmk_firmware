...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  */
  [_BL] = LAYOUT_all(
    KC_ESC,  KC_1,    KC_2,    KC_3,   KC_4,    KC_5,  KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,   KC_BSLS, KC_BSPC, KC_DEL,  KC_PSLS, KC_PAST, TG(_FL2),
  ...
  */
  [_FL1] = LAYOUT_all(
    ...
    _______, _______, _______, M_EMAIL, RESET,   M_TEL, _______, _______, _______, _______, _______, KC_UP, _______,          _______, KC_HOME, _______, KC_PGUP, _______,
    ...
    _______, _______, _______, _______, _______, RGB_TOG, RGB_HUD, RGB_SAI, RGB_VAI, BL_DEC,  BL_INC,  KC_DOWN, KC_RSFT, KC_MUTE, KC_VOLU, KC_END, _______, KC_PGDOWN, _______,
    RGB_MODE_FORWARD, _______, _______,                            BL_TOGG,                            _______, _______, _______, _______, KC_VOLD, _______, KC_INSERT, _______, _______
  ),
  ...
  */
  [_FL2] = LAYOUT_all(
    KC_ESC,  KC_1,    KC_2,    KC_3,   KC_4,    KC_5,  KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,   KC_BSLS, KC_BSPC, KC_DEL,  KC_PSLS, KC_PAST, TG(_FL2),
    KC_TAB,  KC_Q,    KC_W,    KC_F,   KC_P,    KC_G,  KC_J,    KC_L,    KC_U,    KC_Y,    KC_SCLN,    KC_LBRC, KC_RBRC,           KC_BSLS, KC_P7,   KC_P8,   KC_P9,    	KC_PMNS,
    LT(_FL3, KC_BSPC), KC_A,    KC_R,    KC_S,   KC_T,    KC_D,  KC_H,    KC_N,    KC_E,    KC_I,    KC_O, KC_QUOT, KC_NUHS,           KC_ENT,  KC_P4,   KC_P5,   KC_P6,   KC_PPLS,
    KC_LSFT, KC_NUBS, KC_Z,    KC_X,   KC_C,    KC_V,  KC_B,    KC_K,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,  KC_RSFT, LT(_FL3, KC_UP),   KC_P1,   KC_P2,   KC_P3,   KC_SLCK,
    KC_LCTL, KC_LGUI, KC_LALT,                         KC_SPC,                             KC_RALT, KC_RCTL, KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT, KC_P0,   KC_PDOT, KC_PENT  ),


  /* _FL3: Function Layer 2 - For ISO enter use ANSI \
  * ,-------------------------------------------------------------------------------.
  * |   |  |   |   |   |   |   |   |   |   |   |   |   |    |   |    |    |    |    |
  * |-------------------------------------------------------------------------------|
  * |     |   |   |   |   |   |   |   |   |   |   |   |   |     |    |    |    |    |
