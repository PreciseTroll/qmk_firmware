...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
       ...
       KC_TAB,  KC_Q,    KC_W,     M_EMAIL,    RESET,     KC_T,     KC_Y,     KC_U,    KC_I,     KC_O,     KC_P,     KC_LBRC,  KC_RBRC,  KC_BSLS, KC_DELETE, KC_P7,    KC_P8,    KC_P9,    KC_PPLS,\
       KC_TRNS, KC_A,    KC_S,     KC_D,    KC_F,     KC_G,     KC_LEFT,     KC_DOWN,    KC_UP,     KC_RIGHT,     KC_SCLN,  KC_QUOT,  KC_ENT,                 KC_P4,    KC_P5,    KC_P6,          \
